		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comlbflptrackerovp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlbflptrackerovp-display": {
								"semanticObject": "comlbflptrackerovp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lb.flp.tracker.ovp",
									"url": sap.ui.require.toUrl("com/lb/flp/tracker/ovp")
								}
							}
						}
					}
